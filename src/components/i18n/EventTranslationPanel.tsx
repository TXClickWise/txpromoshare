          ...
          {draft && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="rounded-xl border border-border bg-card p-4 space-y-3">
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">Titel</Label>
                  <Input
                    value={draft.title ?? ""}
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">Subtitel</Label>
                  <Input
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">Korte beschrijving</Label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">CTA knoptekst</Label>
                  <Input
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">WhatsApp tekst</Label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">Social tekst</Label>
                  <Textarea
                    rows={2}
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">SEO titel (max 60)</Label>
                  <Input
                    maxLength={60}
                ...
                <div className="space-y-1">
                  <Label className="text-[11px] uppercase tracking-wide text-muted-foreground">SEO beschrijving (max 160)</Label>
                  <Textarea
                    rows={2}
                    maxLength={160}

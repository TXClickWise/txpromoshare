  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_360px] gap-6">
      <div className="space-y-5 min-w-0">
        ...
        <ol className="flex items-center gap-1 sm:gap-2 text-xs font-medium">
          {STEPS.map((s, i) => {
              ...
              {widget.type === "agenda" && (
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-9 w-28"
                  />
                  <p className="text-xs text-muted-foreground">{t("widgetWizard.maxEventsHint")}</p>
                </div>
              )}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between rounded-lg border border-border p-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{t("widgetWizard.showImageHint")}</p>
                </div>
              ...
              <div className="flex items-center justify-between rounded-lg border border-border p-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{t("widgetWizard.showDescHint")}</p>
                </div>
              ...
              <div className="flex items-center justify-between rounded-lg border border-border p-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{t("widgetWizard.showShareHint")}</p>
                </div>
